...
const Home = () => {
  ...
  const loadHomeData = async () => {
    try {
      ...
      const [featured, newItems, discounted, categories] = await Promise.all([
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primary via-gray-800 to-secondary text-white py-20">
      ...
      {/* Flash Deals */}
      <section className="py-16 bg-gradient-to-r from-danger to-red-600 text-white">
        <div className="container-responsive">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Featured Products */}
      <section className="py-16 bg-gradient-to-br from-surface to-gray-50">
        <div className="container-responsive">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
